...
public class ComposicaoExame extends GenericModel {
	...
	public ComposicaoExame(String descricao, UnidadeMedida unidade_medida_id) {
		this.descricao = descricao;
		this.unidade_medida_id = unidade_medida_id;
	}

	public ComposicaoExame(Long id, String descricao, UnidadeMedida unidade_medida_id) {
		this.descricao = descricao;
		this.unidade_medida_id = unidade_medida_id;
		super.setId(id);
	}
